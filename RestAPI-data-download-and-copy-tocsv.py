...
def main():
    ...
    try:
        ...
        output_path = "s3://miscellaneous-vertica-archive-data/iceandfire/characters/"
        df_spark.write.mode("overwrite").parquet(output_path)
        
        # Read the parquet files
        parquet_df = spark.read.parquet("s3://miscellaneous-vertica-archive-data/iceandfire/characters/")
        ...
        filtered_df.write.mode("overwrite").option("header", "true").csv("s3://miscellaneous-vertica-archive-data/iceandfire/characters_csv/")
